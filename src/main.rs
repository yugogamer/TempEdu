        ...
        .service(
            web::scope("/api")
                        .service(web::scope("/v1")
                            ...
                            .service(web::scope("/groupes")
                                .service(controller::groupes::create_groupe)
                                .service(controller::groupes::get_groupes_unprotected)
                                .service(controller::groupes::get_groupes)
                                .service(controller::groupes::set_groupes)
                            )
                        )
        )
    })
